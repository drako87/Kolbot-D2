...
function LoadConfig() {
	...
	Scripts.Diablo = true;
		...
		Config.Diablo.DiabloMsg = "Let's kill Diablo!";
	...
	Scripts.Baal = true;
		Config.Baal.HotTPMessage = "Hot TP! help me clear throne";
		Config.Baal.SafeTPMessage = "Safe TP! GoGo!";
		Config.Baal.BaalMessage = "Let's kill Baal!";
	...
	*/
	...
	Config.UseMP = 70; // Drink a mana potion if mana is under designated percent.
	...
	Config.PingQuit = [{Ping: 900, Duration: 15}, {Ping: 2000, Duration: 2}]; // Quit if ping is over the given value for over the given time period in seconds.

	// Shrine Scanner - scan for shrines while moving.
	// Put the shrine types in order of priority (from highest to lowest). For a list of types, see sdk/shrines.txt
	Config.ScanShrines = [15, 12, 2, 4, 1, 6, 18, 13, 7];

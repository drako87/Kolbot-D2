...
function main() {
	...
	this.summoner = function () {
		...
		Attack.kill(250);
		say("Summoner Done! Go city and wait my tp..");
	...
	this.duriel = function () {
		...
		say("TP Up Duriel Go! Use Staff and enter i save you!");
	...
	this.travincal = function () {
		...
		say("Tp up enter and non move plz!");
	...
	this.mephisto = function () {
		...
		Pather.moveTo(17692, 8023);
		Pather.makePortal();
		say("Done mephisto go city and wait tp on red portal");
		...
		say("Tp Up On Red portal GoGo!");

		while (!this.playerIn()) {
			delay(250);
		}

		say("Act3 Done! Go Act4..");
		//Pather.moveTo(17591, 8070);
	...
	this.diablo = function () {
		...
		say("Tp Up Go! non move i kill diablo..");
		...
		Attack.kill(243);
		say("Diablo is Dead! Go city and talk Tyrael..");

		if (me.gametype > 0) {
			say("Act4 Done! Go Act5..");
...
MainLoop:
	...
	this.radament = function () {
		...
		Pather.makePortal();
		say("Tp Up! enter and wait i kill radament..");
	...
	this.izual = function () {
		...
		Attack.securePosition(me.x, me.y, 30, 3000);
		Pather.makePortal();
		say("Tp Up on izual enter Non Move i kill izual..");
	...
	this.anya = function () {
		...
		Pather.makePortal();
		say("Tp Up Anya! i talk anya you talk Malah for poty");
		...
		say("Anya Done!"); // Mainly for non-questers to know when to get the scroll of resistance
